...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="border-t border-gray-800 pt-5">
      <h3 className="app-section-title uppercase tracking-widest mb-3">{title}</h3>
      {children}
    </section>
  );
}
    ...
    >
      <div className="w-full max-w-md bg-gray-900 border border-gray-700 rounded-xl shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="overflow-y-auto flex-1 p-5 space-y-5">
          ...
          {/* ── Users ─────────────────────────────────────────────────────── */}
          <section>
            <h3 className="app-section-title uppercase tracking-widest mb-3">Users</h3>
            {loadingUsers ? (
          ...
          <Section title="Invite new user">
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full py-2 mt-1 bg-accent-600 hover:bg-accent-500 disabled:bg-gray-800 disabled:text-gray-600 text-white text-sm rounded-lg transition-colors"
          ...
          <Section title="Create agent">
            <div className="space-y-3">
              ...
              <input
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-200 placeholder-gray-600 focus:outline-none focus:border-accent-500"
              />
              <div className="flex items-center gap-3">
