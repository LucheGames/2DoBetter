...
The new bottleneck to development is not implemmentation but the speed that we can conceve of and articulate our ideas. 2Do better's design philosophy is total visability, allowning all your team to see, add and implement ideas at maximum speed.
